...
@section('content')
    ...
    <div class="flex justify-center flex-wrap">
        <div class="inline-block mx-2">
            <div class="w-32 h-48 max-w-xs overflow-hidden bg-[#252525]">
                <div class="w-full h-32 bg-[url({{asset('/Asset/img/c1.svg')}})]">
                </div>
        ...
        <div class="inline-block mx-2">
            <div class="w-32 h-48 max-w-xs overflow-hidden bg-[#252525]">
                <div class="w-full h-32 bg-[url({{asset('/Asset/img/c2.svg')}})]">
                </div>
                <div class="w-full h-16 font-['Nunito'] text-white m-1">
                    <h1 class="text-[16px] font-bold truncate h-8">Nike Air Max 270 React</h1>
                    <div class="h-6 justify-around flex flex-wrap">
    ...
    <div class="flex justify-center flex-wrap">
        <div class="inline-block mx-2">
            <div class="w-32 h-48 max-w-xs overflow-hidden bg-[#252525]">
                <div class="w-full h-32 bg-[url({{asset('/Asset/img/c3.svg')}})]">
                </div>
                <div class="w-full h-16 font-['Nunito'] text-white m-1">
                    <h1 class="text-[16px] font-bold truncate h-8">Nike Air Max 270 React</h1>
                    <div class="h-6 justify-around flex flex-wrap">
        ...
        <div class="inline-block mx-2">
            <div class="w-32 h-48 max-w-xs overflow-hidden bg-[#252525]">
                <div class="w-full h-32 bg-[url({{asset('/Asset/img/c4.svg')}})]">
                </div>
                <div class="w-full h-16 font-['Nunito'] text-white m-1">
                    <h1 class="text-[16px] font-bold truncate h-8">Nike Air Max 270 React</h1>
                    <div class="h-6 justify-around flex flex-wrap">
    ...
    <div class="flex justify-center flex-wrap">
        <div class="inline-block mx-2">
            <div class="w-32 h-48 max-w-xs overflow-hidden bg-[#252525]">
                <div class="w-full h-32 bg-[url({{asset('/Asset/img/c5.svg')}})]">
                </div>
                <div class="w-full h-16 font-['Nunito'] text-white m-1">
                    <h1 class="text-[16px] font-bold truncate h-8">Nike Air Max 270 React</h1>
                    <div class="h-6 justify-around flex flex-wrap">
        ...
        <div class="inline-block mx-2">
            <div class="w-32 h-48 max-w-xs overflow-hidden bg-[#252525]">
                <div class="w-full h-32 bg-[url({{asset('/Asset/img/c6.svg')}})]">
                </div>
                <div class="w-full h-16 font-['Nunito'] text-white m-1">
                    <h1 class="text-[16px] font-bold truncate h-8">Nike Air Max 270 React</h1>
                    <div class="h-6 justify-around flex flex-wrap">
